...
- [Architecture Decision Document](#table-of-contents)
  ...
  - [Starter Template Evaluation](./starter-template-evaluation.md)
    ...
    - [Selected Foundation: HealthCompanion Production Architecture (with planned upgrades)](./starter-template-evaluation.md#selected-foundation-healthcompanion-production-architecture-with-planned-upgrades)
    ...
    - [Upgrade Path (Planned Migrations)](./starter-template-evaluation.md#upgrade-path-planned-migrations)
    - [Core vs. Removable Features](./starter-template-evaluation.md#core-vs-removable-features)
  - [Core Architectural Decisions](./core-architectural-decisions.md)
    ...
    - [SEO Foundations](./core-architectural-decisions.md#seo-foundations)
    - [Go-To-Market Infrastructure](./core-architectural-decisions.md#go-to-market-infrastructure)
